        ...
        if isinstance(ai_response_or_stream, Iterable) and not isinstance(ai_response_or_stream, str):
            ...
            def generate_and_accumulate_stream_response():
                ...
                try:
                    ...
                    elif not accumulated_response and full_ai_response_chunks:  # If chunks exist but resultan empty tras el strip()
            ...
            return Response(
                stream_with_context(generate_and_accumulate_stream_response()),
